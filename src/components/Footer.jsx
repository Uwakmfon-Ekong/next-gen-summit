    ...
    <footer className="bg-[#090909] py-12 text-center text-[#fffdf8]">
      <div className="mx-auto w-[calc(100%-2rem)] max-w-[1180px]">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-5 text-[13px]">
          <a className="border-b border-stone-700 pb-0.5 no-underline hover:border-[#d94a2b]" href="mailto:uwakmfone470@gmail.com">Email</a>
          ...
          <a className="border-b border-stone-700 pb-0.5 no-underline hover:border-[#d94a2b]" href="https://x.com/whakee_" target="_blank" rel="noreferrer">X</a>
        </div>
      </div>
    </footer>
  )
